...
export const loadPresencecourPratique = createAction('[presence cours pratique] load presence', props<{idAutoEcole: any}>());

export const loadedPresencecourPratiqueToStore = createAction('[presence cours pratique] loaded presence theorique to store', props<{payload: any}>());