...
@Component({
  selector: 'app-modal-imprimer-local',
  templateUrl: './modal-imprimer-local.component.html',
  styleUrls: ['./modal-imprimer-local.component.css']
})
export class ModalImprimerLocalComponent implements OnInit {
